...
import { DEVLISTENER, TYNativeBridge, WARNMESSAGEARRIVED } from './bridgeUtils';
...
const TuyaDeviceApi = {
  ...
  registerWarnMessageListener(params, onWarnMessageArrived) {
    ...
    return TYNativeBridge.on(TYNativeBridge.bridge(WARNMESSAGEARRIVED, params.devId), data => {
