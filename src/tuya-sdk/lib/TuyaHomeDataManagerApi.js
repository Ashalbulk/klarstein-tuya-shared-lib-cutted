import { SEARCHDEVICE, TYNativeBridge } from './bridgeUtils';
...
const TuyaHomeDataManagerApi = {
  ...
  getDeviceBeanWithoutCache(params) {
    return HomeDataManagerNativeApi.getDeviceBeanWithoutCache(params);
  },
  ...
  getSchemaJsonString(params) {
    return HomeDataManagerNativeApi.getSchemaJsonString(params);
  },
  queryDev(params) {
    return HomeDataManagerNativeApi.queryDev(params);
  },
  discoveredLanDevice(onDeviceFind) {
